...
> Answer: the class is factor because it has a list of possible values
...
```{r}
ggplot(Neonics) +
  geom_freqpoly(aes(x = Publication.Year), bins = 10, color = 'maroon') +
  geom_freqpoly(aes(x = Test.Location), bins = 10, color = 'blue')
```
